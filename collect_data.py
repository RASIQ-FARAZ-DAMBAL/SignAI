...
# ================= SETTINGS =================
ALL_SIGNS       = list("ABCDEFGHIJKLMNOPQRSTUVWXYZ") + list("123456789")
...
parser = argparse.ArgumentParser(description="SignBridge Data Collector")
parser.add_argument(
...
with HandLandmarker.create_from_options(options) as landmarker:
    for sign_idx, sign in enumerate(SIGNS):
        ...
        while True:
            ...
            cv2.putText(frame, f"Existing samples: {start_idx}", (30, 100),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (180, 180, 180), 1)
            cv2.putText(frame, "SPACE = start | ESC = skip | Q = quit", (30, 140),
